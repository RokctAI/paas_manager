...
![Everything else, one tap away](screenshots/08-restaurant_hub.png)
...
![Nothing gets lost offline](screenshots/09-sync_issues.png)
...
![Your menu, organised](screenshots/10-menu.png)
...
![List a product in minutes](screenshots/11-add_product.png)

Name it, price it, stock it - a new product is ready to sell in minutes.

## 12. Every order, one queue

![Every order, one queue](screenshots/12-order_queue.png)
...
![The paper trail, kept](screenshots/13-order_history.png)
...
![The kitchen sees every order](screenshots/14-kitchen_queue.png)
...
![Speak your language](screenshots/15-comms_language.png)
...
![A calculator, right where you work](screenshots/19-calc_keypad.png)
