                      ...
                      child: Column(
                        children: [
                          ...
                          UnderlinedTextField(
                            ...
                            inputType: TextInputType.number,
                            textInputAction: TextInputAction.next,
                            // BEST: Use the state value which should already be properly set
                            initialText: state.tax, // This should show "0" when tax is 0
                              ...
                              Column(
                                children: [
                                  ...
                                  CustomToggle(
                                    ...
                                    onChange: event.setActive, // This will now work properly
                                  ),
                                ],
                              ),
                            ],
                            ...
                            onPressed: () {
                              if (_formKey.currentState?.validate() ?? false) {
                                event.updateProduct(
                                  ...
                                  updated: (product) {
                                    debugPrint('=== UPDATE SUCCESS CALLBACK ===');
                                    debugPrint('Updated product tax: ${product?.tax}');
                                    debugPrint('Updated product stocks tax: ${product?.stocks?.map((s) => s.tax).toList()}');
                                    widget.onSave();
