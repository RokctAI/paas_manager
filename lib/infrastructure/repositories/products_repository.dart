...
class ProductsRepository implements ProductsInterface {
  ...
  Future<ApiResult<SingleProductResponse>> updateProduct({
    ...
    debugPrint('Raw tax parameter: "$tax" (${tax.runtimeType})');
    debugPrint('Parsed tax: ${num.tryParse(tax)}');
    ...
    final data = {
      ...
      'active': active ? 1 : 0, // Should send 1 or 0
    ...
    debugPrint('Final request data:');
    debugPrint('  active: ${data['active']} (${data['active'].runtimeType})');
    debugPrint('  tax: ${data['tax']} (${data['tax'].runtimeType})');
    debugPrint('  uuid: $uuid');
    debugPrint('Full request: ${jsonEncode(data)}');
    debugPrint('=================================');
