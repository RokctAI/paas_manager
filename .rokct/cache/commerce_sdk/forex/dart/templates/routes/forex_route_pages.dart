...
// wallet_sdk's WalletRepositoryFacade, which bundles the money-moving
// sends (sendWalletToPhone(), sendWalletByCode()) and walletTopUp()
// alongside the reads. Forex reads the wallet and never
