...
import 'package:marketplace_sdk/src/common/application/customer/search/search_notifier.dart';
import 'package:marketplace_sdk/src/common/application/customer/search/search_provider.dart';
import 'package:base_sdk/src/application/main/main_provider.dart';
import 'package:marketplace_sdk/src/common/presentation/pages/search/shimmer/category_shimmer.dart';
import 'package:marketplace_sdk/src/common/presentation/pages/search/shimmer/search_product_shimmer.dart';
import 'package:marketplace_sdk/src/common/presentation/pages/search/shimmer/search_shop_shimmer.dart';
import 'package:marketplace_sdk/src/common/presentation/pages/search/widgets/product_item.dart';
import 'package:marketplace_sdk/src/common/presentation/pages/search/widgets/restaurant_item.dart';
import 'package:marketplace_sdk/src/common/presentation/pages/search/widgets/search_result.dart';
