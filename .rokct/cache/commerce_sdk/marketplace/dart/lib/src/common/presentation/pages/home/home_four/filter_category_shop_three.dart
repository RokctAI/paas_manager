...
import 'package:marketplace_sdk/src/common/presentation/pages/home/home_four/filter/filter_page.dart';
...
class FilterCategoryShopThree extends StatelessWidget {
  ...
  Widget _resultEmpty(BuildContext context) {
    return EmptyBadge(
      ...
      onLinkTap: () {
        AppRoutes.I.pushChatRoute(context, roleId: "admin", name: "Admin");
      },
    );
  }
}
