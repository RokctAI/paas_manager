...
/// State for the primary (proxied, weatherapi.com-shaped) weather feed.
/// Ported unchanged from pos main's `weather/service/weather_state.dart`.
class WeatherState {
  ...
  double get temperature {
    try {
      ...
      debugLog('Error getting temperature: $e');
      return 0.0;
    }
  }
  ...
  double get humidity {
    try {
      ...
      debugLog('Error getting humidity: $e');
      return 0.0;
    }
  }
  ...
  List<Map<String, dynamic>> getHourlyForecast(int dayIndex) {
    try {
      ...
      debugLog('Error getting hourly forecast: $e');
      return [];
    }
  }
  ...
  Map<String, dynamic> getDailySummary(int dayIndex) {
    try {
      ...
      debugLog('Error getting daily summary: $e');
  ...
  double getHourlyTemperature(int dayIndex, int hour) {
    try {
      ...
      debugLog('Error getting hourly temperature: $e');
      return 0.0;
    }
  }
