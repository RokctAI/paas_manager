...
void main() {
  ...
  const expectedRoutes = <String, String>{
    '/order': 'OrdersListRoute',
    '/orderScreen': 'OrderRoute',
    '/order_progress': 'OrderProgressRoute',
    '/parcel_page': 'ParcelRoute',
    '/info_screen': 'InfoRoute',
    '/parcel_list_page': 'ParcelListRoute',
    '/parcel_progress_page': 'ParcelProgressRoute',
  };
  const expectedSeams = <String>[
    'pushOrdersListRoute',
    'replaceOrdersListRoute',
    'pushOrderRoute',
    'pushOrderProgressRoute',
    'pushParcelRoute',
    'pushInfoRoute',
    'replaceInfoRoute',
    'pushParcelListRoute',
    'replaceParcelListRoute',
    'pushParcelProgressRoute',
  ];

  group('orders_sdk manifest route wiring (app_type.customer)', () {
